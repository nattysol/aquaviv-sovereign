...
// 1. UPDATED QUERY: Now fetching the Shopify Variant IDs
...
// 2. CONFIG: Your Shopify Store Domain
// Replace this with your actual shopify domain (e.g. 'aquaviv.myshopify.com')
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-10 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            ...
            {/* The Bundle Engine (Connected to Shopify) */}
            <ProductForm 
